  ...
  return (
   ...
   <div style={{paddingTop:'100px'}} className='container px-4 mx-auto'> 
   {
    ...
    <div className="flex justify-center items-center my-5 text-lg">
      <img width={'70px'} height={'70px'} className='me-3' src="https://media.tenor.com/tga0EoNOH-8AAAAM/loading-load.gif" alt="" />
      Loading..</div>
    :
    <>
      <div className="grid grid-cols-4 gap-4">
        { allProducts?.length>0 ?
          ...
          :
          <div className="flex justify-center items-center font-bold text-red-600 my-5 text-lg">Product Not Found!!
         </div>  
