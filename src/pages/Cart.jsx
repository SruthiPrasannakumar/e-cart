      ...
      <div className='grid grid-cols-3 gap-4 mt-5'>
        <div className='col-span-2 border rounded p-5 shadow'>
          <table className='table-auto w-full'>
            ...
            <tbody>
              <tr>
                <td>1</td>
                <td>Product name</td>
                <td><img width={'70px'} height={'70px'} src="https://images.pexels.com/photos/90946/pexels-photo-90946.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="" /></td>
                <td>
                  <div className="flex">
          ...
          <div className="float-right mt-5">
            ...
            <Link to={'/'} className='bg-blue-600 ms-3 rounded p-2 text-white'>SHOP MORE
            </Link>
          </div>
        ...
        <div className="col-span-1">
          <div className="border rounded shadow p-5">
            ...
            <hr />
            <button className='bg-green-600 rounded p-2 text-xl texxt-white w-full mt-4'>CHECK OUT</button>
